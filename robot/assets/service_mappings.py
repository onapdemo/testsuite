...
'''
GLOBAL_SERVICE_FOLDER_MAPPING = {"AzurevFW" : ['AzurevFW/vSNK', 'AzurevFW/vPKG'], \
                                 "vFW" : ['vFW'], \
                                 "AzurevDNS" : ['AzurevDNS'], \
                                 "vLB" : ['vLB'], \
                                 "vVG" : ['vVG'], \
...
GLOBAL_SERVICE_VNF_MAPPING = {
    ...
    "vFWCL"  : ['vFWSNK', 'vPKG'],
    "AzurevDNS" : ['AzurevDNS'],
    "AzurevFW"  : ['AzurevFWSNK', 'AzurevPKG'],
}
...
GLOBAL_SERVICE_TEMPLATE_MAPPING = {
    ...
    "AzurevFWSNK" : [{"isBase" : "true",   "template" : "azurevfwsnk_preload.template", "name_pattern": "azurevsnk"}],
    "AzurevPKG"   : [{"isBase" : "true",  "template" : "azurevpkg_preload.template", "name_pattern": "azurevpkg"}],
    "AzurevDNS"   : [{"isBase" : "true",  "template" : "azurevdns_preload.template", "name_pattern": "azurevdns"}]
}
